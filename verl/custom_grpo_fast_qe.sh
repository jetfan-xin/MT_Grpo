...
export WANDB_PROJECT="qwen2.5_7b_grpo_mt"
...
########## 3) 训练超参 ##########
# runs目录保存log和验证输出
runs_path="${MY_DIR}/MT_Grpo/runs/qwen2.5_7b_grpo_mt/xcomet_${WORD_QE_MODE}"
# 训练中周期性保存的模型参数(每 40 step)
checkpoints_path="${MY_DIR}/MT_Grpo/checkpoints/qwen2.5_7b_grpo_mt/xcomet_${WORD_QE_MODE}/trainer_npus_${gpu_count}"
# 自定义奖励计算代码路径
